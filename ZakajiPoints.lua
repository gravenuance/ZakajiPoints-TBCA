...
SlashCmdList.ZAKAJIBALLS = function(msg)
    ...
    elseif msg == "frost" then
        db.frostTracker = not db.frostTracker
        if ZakajiFrost_UpdateIcon then
            ZakajiFrost_UpdateIcon()
        end
        print("ZakajiBalls: frost tracker is now " .. (db.frostTracker and "ON" or "OFF"))
    else
        ...
        print("/balls frost - toggle frost tracker display")
    end
end
